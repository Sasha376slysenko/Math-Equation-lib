...
|1. ADD, SUB, BRACKET =======================|
|2. MUL, DIV, BRACKET =======================|
|3. ADD, SUB, MUL, DIV BRACKET ==============|
+--------------------------------------------+
"""
@app.route('/add_sub_br', methods=['GET'])
@log_request_response
def add_sub_br():
    global set_equations

    random_digit: int = random.randint(0, 9)
...
@app.route('/mul_div_br', methods=['GET'])
@log_request_response
def mul_div_br():
    global set_equations
...
@app.route('/add_sub_mul_div_br', methods=['GET'])
@log_request_response
def add_sub_mul_div_br():
    global set_equations
