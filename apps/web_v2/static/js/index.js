        ...
        switch (event.target.id) {
            ...
            case 'ButtonInput':
                ...
                if (correctIncorrectEquation && correctIncorrectEquation !== 'ERROR'){
                    ...
                    // elDivEquationResult -> change
                    dynamicElDivEquationResult();
                    ...
                    // elDivEquationResult -> change
                    dynamicElDivEquationResult(false);
...
// Boolean -> Flag Button
let flagButtonLevel4 = false;
let flagButtonLevel5 = false;
let flagButtonLevel6 = false;
let flagButtonLevel7 = false;
let flagButtonLevel8 = false;
// boolean -> Other
let isRunning = false;
...
const elDivSymbolsMath = document.createElement('div');
const elDivLevel4SymbolsMath = document.createElement('div');
const elDivLevel5SymbolsMath = document.createElement('div');
const elDivLevel6SymbolsMath = document.createElement('div');
const elDivLevel7SymbolsMath = document.createElement('div');
const elDivLevel8SymbolsMath = document.createElement('div');
const elDivLevel4SymbolsMathEquals = document.createElement('div');
const elDivLevel5SymbolsMathEquals = document.createElement('div');
const elDivLevel6SymbolsMathEquals = document.createElement('div');
const elDivLevel7SymbolsMathEquals = document.createElement('div');
const elDivLevel8SymbolsMathEquals = document.createElement('div');
...
let mathOperatorsReapet_save_i = [];
...
// Dict symbol Math Level Beginner
let dictSymbolMathLevel4 = {};
let dictSymbolMathLevel4Equals = {}

// Dict Symbol Math Level WarmUp Level
let dictSymbolMathLevel5 = {};
let dictSymbolMathLevel5Equals = {};

// Dict Symbol Math Master Level
let dictSymbolMathLevel6 = {};
let dictSymbolMathLevel6Equals = {};

// Dict Symbol Math Pro level
let dictSymbolMathLevel7 = {};
let dictSymbolMathLevel7Equals = {};

// Dict Symbol Math Expert Level
let dictSymbolMathLevel8 = {};
let dictSymbolMathLevel8Equals = {};

// Dict SymbolMath append => Master, Pro, Expert
let dictSymbolMath = {};

dictSymbolMathLevel4Equals['divAdd'] = document.createElement('div');
dictSymbolMathLevel4Equals['divSub'] = document.createElement('div');
dictSymbolMathLevel4Equals['divMul'] = document.createElement('div');
dictSymbolMathLevel4Equals['divTruediv'] = document.createElement('div');
dictSymbolMathLevel4Equals['divBracketLeft'] = document.createElement('div');
dictSymbolMathLevel4Equals['divBracketRight'] = document.createElement('div');
dictSymbolMathLevel4Equals['divEquals'] = document.createElement('div');

dictSymbolMathLevel5Equals['divAdd'] = document.createElement('div');
dictSymbolMathLevel5Equals['divSub'] = document.createElement('div');
dictSymbolMathLevel5Equals['divMul'] = document.createElement('div');
dictSymbolMathLevel5Equals['divTruediv'] = document.createElement('div');
dictSymbolMathLevel5Equals['divBracketLeft'] = document.createElement('div');
dictSymbolMathLevel5Equals['divBracketRight'] = document.createElement('div');
dictSymbolMathLevel5Equals['divEquals'] = document.createElement('div');

dictSymbolMathLevel6Equals['divAdd'] = document.createElement('div');
dictSymbolMathLevel6Equals['divSub'] = document.createElement('div');
dictSymbolMathLevel6Equals['divMul'] = document.createElement('div');
dictSymbolMathLevel6Equals['divTruediv'] = document.createElement('div');
dictSymbolMathLevel6Equals['divBracketLeft'] = document.createElement('div');
dictSymbolMathLevel6Equals['divBracketRight'] = document.createElement('div');
dictSymbolMathLevel6Equals['divEquals'] = document.createElement('div');

dictSymbolMathLevel7Equals['divAdd'] = document.createElement('div');
dictSymbolMathLevel7Equals['divSub'] = document.createElement('div');
dictSymbolMathLevel7Equals['divMul'] = document.createElement('div');
dictSymbolMathLevel7Equals['divTruediv'] = document.createElement('div');
dictSymbolMathLevel7Equals['divBracketLeft'] = document.createElement('div');
dictSymbolMathLevel7Equals['divBracketRight'] = document.createElement('div');
dictSymbolMathLevel7Equals['divEquals'] = document.createElement('div');

dictSymbolMathLevel8Equals['divAdd'] = document.createElement('div');
dictSymbolMathLevel8Equals['divSub'] = document.createElement('div');
dictSymbolMathLevel8Equals['divMul'] = document.createElement('div');
dictSymbolMathLevel8Equals['divTruediv'] = document.createElement('div');
dictSymbolMathLevel8Equals['divBracketLeft'] = document.createElement('div');
dictSymbolMathLevel8Equals['divBracketRight'] = document.createElement('div');
dictSymbolMathLevel8Equals['divEquals'] = document.createElement('div');

dictSymbolMath['divAdd'] = document.createElement('div');
dictSymbolMath['divSub'] = document.createElement('div');
dictSymbolMath['divMul'] = document.createElement('div');
dictSymbolMath['divTruediv'] = document.createElement('div');
dictSymbolMath['divBracketLeft'] = document.createElement('div');
dictSymbolMath['divBracketRight'] = document.createElement('div');
dictSymbolMath['divEquals'] = document.createElement('div');
...
const arrayKeySymbolMath = ['divAdd', 'divSub', 'divMul', 'divTruediv', 'divBracketLeft', 'divBracketRight', 'divEquals'];
const arrayH1Symbol = ["+", "-", "*", "/", "(", ")", "="];
...
function appendDictSymbolMath(dict, arrayH1, arrayH1Symbol, arrayKeySymbolMath, length_elements){
    for(let i = 0; i < length_elements; i++){
        ...
        dict[arrayKeySymbolMath[i]].appendChild(arrayH1[i].cloneNode(true));
    }
}
...
/*
 * +-----------------------------+
 * |dicSymbolMath Beginner Level |
 * +-----------------------------+
 */
arrayKeySymbolMath.forEach(key => {
    counterItemSymbol++;
    dictSymbolMathLevel4Equals[key].draggable = true;
    dictSymbolMathLevel4Equals[key].id = 'ItemSymbol' + counterItemSymbol;
    dictSymbolMathLevel4Equals[key].classList.add('ItemSymbol');
});

appendDictSymbolMath(
    dictSymbolMathLevel4Equals,
    arrayH1,
    arrayH1Symbol,
    arrayKeySymbolMath,
    arrayKeySymbolMath.length
)

keySymbolMath(
    arrayKeySymbolMath,
    dictSymbolMathLevel4,
    dictSymbolMathLevel4Equals
);

/*
 * +---------------------------+
 * |dicSymbolMath WarmUp Level |
 * +---------------------------+
 */
counterItemSymbol = 0;
arrayKeySymbolMath.forEach(key => {
    counterItemSymbol++;
    dictSymbolMathLevel5Equals[key].draggable = true;
    dictSymbolMathLevel5Equals[key].id = 'ItemSymbol' + counterItemSymbol;
    dictSymbolMathLevel5Equals[key].classList.add('ItemSymbol');
});

appendDictSymbolMath(
    dictSymbolMathLevel5Equals,
    arrayH1,
    arrayH1Symbol,
    arrayKeySymbolMath,
    arrayKeySymbolMath.length
...
keySymbolMath(
    arrayKeySymbolMath,
    dictSymbolMathLevel5,
    dictSymbolMathLevel5Equals
);

/*
 * +---------------------------+
 * |dicSymbolMath Master Level |
 * +---------------------------+
 */
counterItemSymbol = 0;
arrayKeySymbolMath.forEach(key => {
    counterItemSymbol++;
    dictSymbolMathLevel6Equals[key].draggable = true;
    dictSymbolMathLevel6Equals[key].id = 'ItemSymbol' + counterItemSymbol;
    dictSymbolMathLevel6Equals[key].classList.add('ItemSymbol');
});

appendDictSymbolMath(
    dictSymbolMathLevel6Equals,
    arrayH1,
    arrayH1Symbol,
    arrayKeySymbolMath,
    arrayKeySymbolMath.length
...
keySymbolMath(
    arrayKeySymbolMath,
    dictSymbolMathLevel6,
    dictSymbolMathLevel6Equals
);

/*
 * +------------------------+
 * |dicSymbolMath Pro Level |
 * +------------------------+
 */
counterItemSymbol = 0;
arrayKeySymbolMath.forEach(key => {
    counterItemSymbol++;
    dictSymbolMathLevel7Equals[key].draggable = true;
    dictSymbolMathLevel7Equals[key].id = 'ItemSymbol' + counterItemSymbol;
    dictSymbolMathLevel7Equals[key].classList.add('ItemSymbol');
});

appendDictSymbolMath(
    dictSymbolMathLevel7Equals,
    arrayH1,
    arrayH1Symbol,
    arrayKeySymbolMath,
    arrayKeySymbolMath.length
...
keySymbolMath(
    arrayKeySymbolMath,
    dictSymbolMathLevel7,
    dictSymbolMathLevel7Equals
);

/*
 * +---------------------------+
 * |dicSymbolMath Expert Level |
 * +---------------------------+
 */
counterItemSymbol = 0;
arrayKeySymbolMath.forEach(key => {
    counterItemSymbol++;
    dictSymbolMathLevel8Equals[key].draggable = true;
    dictSymbolMathLevel8Equals[key].id = 'ItemSymbol' + counterItemSymbol;
    dictSymbolMathLevel8Equals[key].classList.add('ItemSymbol');
});

appendDictSymbolMath(
    dictSymbolMathLevel8Equals,
    arrayH1,
    arrayH1Symbol,
    arrayKeySymbolMath,
    arrayKeySymbolMath.length
...
arrayKeySymbolMath.forEach(key => {
    counterItemSymbol++;
    dictSymbolMath[key].draggable = true;
    dictSymbolMath[key].id = 'ItemSymbol' + counterItemSymbol;
    dictSymbolMath[key].classList.add('ItemSymbol');
});
...
function updateVariable(marker=true){
    if (marker){
        flagButtonLevel4 = false;
        flagButtonLevel5 = false;
        flagButtonLevel6 = false;
        flagButtonLevel7 = false;
        flagButtonLevel8 = false;
    }
    InputEquation = "";
...
function dynamicElDivEquationResult(flag=true){
    if (flag){
        elDivEquationResult.style.backgroundColor = '#a4efa4';
    }else{
        elDivEquationResult.style.backgroundColor = '#FFCDD2';
    }

    setTimeout(function(){
        elDivEquationResult.style.backgroundColor = '#D6D6D6';
    }, 2000);
}
...
async function eq_4(){
    try{
        const response = await fetch('/eq_4', {
            method: 'GET',
            headers: {
...
async function eq_5(){
    try{
        const response = await fetch('/eq_5', {
            method: 'GET',
            headers: {
                "Content-Type": "application/json"
            }
...
async function eq_6(){
    try{
        const response = await fetch('/eq_6', {
            method: 'GET',
            headers: {
                "Content-Type": "application/json"
            }
...
async function eq_7(){
    try{
        const response = await fetch('/eq_7', {
            method: 'GET',
            headers: {
                "Content-Type": "application/json"
            }
...
async function eq_8(){
    try{
        const response = await fetch('/eq_8', {
            method: 'GET',
            headers: {
                "Content-Type": "application/json"
            }
...
async function waitForIntervalToFinish(){
    return new Promise(resolve => {
        const intervalDigits = setInterval(async () => {
            ...
            if (flagButtonLevel4){ await eq_4(); }
            if (flagButtonLevel5){ await eq_5(); }
            if (flagButtonLevel6){ await eq_6(); }
            if (flagButtonLevel7){ await eq_7(); }
            if (flagButtonLevel8){ await eq_8(); }
...
async function startGame() {
    ...
    const WarmUpLevel = document.getElementById('WarmUpLevel');
    const MasterLevel = document.getElementById('MasterLevel');
    const ProLevel = document.getElementById('ProLevel');
    const ExpertLevel = document.getElementById('ExpertLevel');

    if (BeginnerLevel && WarmUpLevel && MasterLevel && ProLevel && ExpertLevel) {
        BeginnerLevel.remove();
        WarmUpLevel.remove();
        MasterLevel.remove();
        ProLevel.remove();
        ExpertLevel.remove();
...
function mathOperatorsRepeat(element_div, count_repeat){
    mathOperatorsReapet_save_i = [];

    for (let i = 0; i < count_repeat; i++) {
        const clone = elDivSymbolsMath.cloneNode(true);
        counterItemSymbol++;
        clone.id = "ItemSymbol" + "_clone_" + counterItemSymbol;
        ...
        element_div.appendChild(clone);
        mathOperatorsReapet_save_i.push(clone.id);
    }
}
...
function updateDigits(){
    ...
    if(flagButtonLevel4){
        while(elDivLevel4SymbolsMath.firstChild){
            elDivLevel4SymbolsMath.removeChild(elDivLevel4SymbolsMath.firstChild);
        }
    }

    if (flagButtonLevel5){
        while(elDivLevel5SymbolsMath.firstChild){
            elDivLevel5SymbolsMath.removeChild(elDivLevel5SymbolsMath.firstChild);
        }
    }

    if(flagButtonLevel6){
        while(elDivLevel6SymbolsMath.firstChild){
            elDivLevel6SymbolsMath.removeChild(elDivLevel6SymbolsMath.firstChild);
        }
    }

    if(flagButtonLevel7){
        while(elDivLevel7SymbolsMath.firstChild){
            elDivLevel7SymbolsMath.removeChild(elDivLevel7SymbolsMath.firstChild);
        }
    }

    if(flagButtonLevel8){
        while(elDivLevel8SymbolsMath.firstChild){
            elDivLevel8SymbolsMath.removeChild(elDivLevel8SymbolsMath.firstChild);
        }
    }
    ...
    // START -> Element Div Symbols Math
    while(elDivSymbolsMath.firstChild){
        elDivSymbolsMath.removeChild(elDivSymbolsMath.firstChild);
    }

    for(let i = 0; i < mathOperatorsReapet_save_i.length; i ++){
        elementDraggable(
            'ItemSymbol',
            'elDivEquationResult',
            mathOperatorsReapet_save_i[i]
        );
    }
    // END -> Element Div Symbols Math
    ...
    if(flagButtonLevel4){
        ...
        appendSymbolsMath(
            arrayKeySymbolMath,
            true,
            elDivLevel4SymbolsMathEquals, //Equals
            dictSymbolMathLevel4Equals
        );
        elementDraggable(
            'ItemSymbol',
    ...
    if(flagButtonLevel5){
        ...
        appendSymbolsMath(
            arrayKeySymbolMath,
            true,
            elDivLevel5SymbolsMathEquals, //Equals
            dictSymbolMathLevel5Equals
        );
        elementDraggable(
            'ItemSymbol',
    ...
    if(flagButtonLevel6){
        ...
        appendSymbolsMath(
            arrayKeySymbolMath,
            true,
            elDivLevel6SymbolsMathEquals, //Equals
            dictSymbolMathLevel6Equals
        );
        elementDraggable(
            'ItemSymbol',
    ...
    if(flagButtonLevel7){
        ...
        appendSymbolsMath(
            arrayKeySymbolMath,
            true,
            elDivLevel7SymbolsMathEquals, //Equals
            dictSymbolMathLevel7Equals
        );
        elementDraggable(
            'ItemSymbol',
    ...
    if(flagButtonLevel8){
        ...
        appendSymbolsMath(
            arrayKeySymbolMath,
            true,
            elDivLevel8SymbolsMathEquals, //Equals
            dictSymbolMathLevel8Equals
        );
        elementDraggable(
            'ItemSymbol',
...
function dialogBox(flagDialogBox) {
    if(flagButtonLevel4){
        ...
        widthTabel = '600px';
        heightTabel = '400px';
    }else if(flagButtonLevel6){
        counterSymbolsMat = 2;
        widthEquationResult = '760';
        widthDigitsResult = '300px';
        marginTopGeneralLevel = '140px';
        widthTabel = '600px';
        heightTabel = '400px';
    }else if(flagButtonLevel7){
        counterSymbolsMat = 2;
        widthEquationResult = '810';
        widthDigitsResult = '300px';
        marginTopGeneralLevel = '140px';
        widthTabel = '600px';
        heightTabel = '400px';
    ...
    if(flagDialogBox){
        ...
        // SYMBOL MATH  GLOBAL => START
        elementAlignmentRow(elDivSymbolsMath, false);
        elDivSymbolsMath.id = 'elDivSymbolsMath';
        elDivSymbolsMath.classList.add('elDivSymbolsMath');
        // SYMBOL MATH GLOBAL => END

        //symbols append start
        if(flagButtonLevel4){
            elementAlignmentRow(elDivLevel4SymbolsMath, false);
            elementAlignmentRow(elDivLevel4SymbolsMathEquals, false); //Equals

            elDivLevel4SymbolsMath.id = 'elDivLevel4SymbolsMath';
            elDivLevel4SymbolsMathEquals.id = 'elDivLevel4SymbolsMathEquals'; //Equals

            elDivLevel4SymbolsMath.classList.add('elDivLevel4SymbolsMath');
            elDivLevel4SymbolsMathEquals.classList.add('elDivLevel4SymbolsMathEquals'); //Equals
            ...
            basicDiv.appendChild(elDivLevel4SymbolsMath);
            mathOperatorsRepeat(basicDiv, 1);
            basicDiv.appendChild(elDivLevel4SymbolsMathEquals); // Equals
        }

        if(flagButtonLevel5) {
            elementAlignmentRow(elDivLevel5SymbolsMath, false);
            elementAlignmentRow(elDivLevel5SymbolsMathEquals, false); //Equals

            elDivLevel5SymbolsMath.id = 'elDivLevel5SymbolsMath';
            elDivLevel5SymbolsMathEquals.id = 'elDivLevel5SymbolsMathEquals'; //Equals

            elDivLevel5SymbolsMath.classList.add('elDivLevel5SymbolsMath');
            elDivLevel5SymbolsMathEquals.classList.add('elDivLevel5SymbolsMathEquals'); //Equals
            ...
            basicDiv.appendChild(elDivLevel5SymbolsMath);
            mathOperatorsRepeat(basicDiv, 2);
            basicDiv.appendChild(elDivLevel5SymbolsMathEquals); // Equals
        }

        if(flagButtonLevel6) {
            elementAlignmentRow(elDivLevel6SymbolsMath, false);
            elementAlignmentRow(elDivLevel6SymbolsMathEquals, false); //Equals

            elDivLevel6SymbolsMath.id = 'elDivLevel6SymbolsMath';
            elDivLevel6SymbolsMathEquals.id = 'elDivLevel6SymbolsMathEquals'; //Equals

            elDivLevel6SymbolsMath.classList.add('elDivLevel6SymbolsMath');
            elDivLevel6SymbolsMathEquals.classList.add('elDivLevel6SymbolsMathEquals'); //Equals
            ...
            basicDiv.appendChild(elDivLevel6SymbolsMath);
            mathOperatorsRepeat(basicDiv, 3);
            basicDiv.appendChild(elDivLevel6SymbolsMathEquals); // Equals
        }

        if(flagButtonLevel7) {
            elementAlignmentRow(elDivLevel7SymbolsMath, false);
            elementAlignmentRow(elDivLevel7SymbolsMathEquals, false); //Equals

            elDivLevel7SymbolsMath.id = 'elDivLevel7SymbolsMath';
            elDivLevel7SymbolsMathEquals.id = 'elDivLevel7SymbolsMathEquals'; //Equals

            elDivLevel7SymbolsMath.classList.add('elDivLevel7SymbolsMath');
            elDivLevel7SymbolsMathEquals.classList.add('elDivLevel7SymbolsMathEquals'); //Equals
            ...
            basicDiv.appendChild(elDivLevel7SymbolsMath);
            mathOperatorsRepeat(basicDiv, 5);
            basicDiv.appendChild(elDivLevel7SymbolsMathEquals); // Equals
        }

        if(flagButtonLevel8) {
            elementAlignmentRow(elDivLevel8SymbolsMath, false);
            elementAlignmentRow(elDivLevel8SymbolsMathEquals, false); //Equals

            elDivLevel8SymbolsMath.id = 'elDivLevel8SymbolsMath';
            elDivLevel8SymbolsMathEquals.id = 'elDivLevel8SymbolsMathEquals'; //Equals

            elDivLevel8SymbolsMath.classList.add('elDivLevel8SymbolsMath');
            elDivLevel8SymbolsMathEquals.classList.add('elDivLevel8SymbolsMathEquals'); //Equals
            ...
            basicDiv.appendChild(elDivLevel8SymbolsMath);
            mathOperatorsRepeat(basicDiv, 6);
            basicDiv.appendChild(elDivLevel8SymbolsMathEquals); // Equals
        }
        //symbols append end
...
async function checkInputDialogBox() {
    if(flagButtonLevel4) {
        ...
        minLengthCheckInput = 11;
    }else if(flagButtonLevel7){
        minLengthCheckInput = 13;
    }else{
        minLengthCheckInput = 15;
    }
    ...
    if (is_ukrainian){
        switch (counterTutorial){
            ...
            case 3:
                ...
                break;
            case 4:
                tutorial.src = '/static/tutorialPng_uk/tutorial_slide_5_uk.png';
                break;
            case 5:
                tutorial.src = '/static/tutorialPng_uk/tutorial_slide_6_uk.png';
                break;
            case 6:
                tutorial.src = '/static/tutorialPng_uk/tutorial_slide_7_uk.png';
                break;
            case 7:
                tutorial.src = '/static/tutorialPng_uk/tutorial_slide_8_uk.png';
                break;
            case 8:
                tutorial.src = '/static/tutorialPng_uk/tutorial_slide_9_uk.png';
                break;
            default:
                counterTutorial = 0;
        ...
        switch (counterTutorial){
            ...
            case 3:
                ...
                break;
            case 4:
                tutorial.src = '/static/tutorialPng_en/tutorial_slide_5_en.png';
                break;
            case 5:
                tutorial.src = '/static/tutorialPng_en/tutorial_slide_6_en.png';
                break;
            case 6:
                tutorial.src = '/static/tutorialPng_en/tutorial_slide_7_en.png';
                break;
            case 7:
                tutorial.src = '/static/tutorialPng_en/tutorial_slide_8_en.png';
                break;
            case 8:
                tutorial.src = '/static/tutorialPng_en/tutorial_slide_9_en.png';
                break;
            default:
                counterTutorial = 0;
...
function onClick(){
    ...
    if(flagGameDescription) {
        ...
        const BeginnerLevel = document.createElement('button');
        const WarmUpLevel = document.createElement('button');
        const MasterLevel = document.createElement('button');
        const ProLevel = document.createElement('button');
        const ExpertLevel = document.createElement('button');
        const newForm = document.createElement('form');


        function buttonLanguage_2(arrayLabels){
            BeginnerLevel.id = 'BeginnerLevel';
            WarmUpLevel.id = 'WarmUpLevel';
            MasterLevel.id = 'MasterLevel';
            ProLevel.id = 'ProLevel';
            ExpertLevel.id = 'ExpertLevel';
            BeginnerLevel.innerText = arrayLabels[0];
            WarmUpLevel.innerText = arrayLabels[1];
            MasterLevel.innerText = arrayLabels[2];
            ProLevel.innerText = arrayLabels[3];
            ExpertLevel.innerText = arrayLabels[4];
        }


        if (is_ukrainian){
            buttonLanguage_2(['Початковий', 'Розминка', 'Мастер', 'Про', 'Експерт']);
        }else{
            buttonLanguage_2(['Beginner', 'Warm up', 'Master', 'Pro', 'Expert']);
        }

        newForm.id = 'newForm'
        newForm.style.gap = '10px';
        newForm.style.marginTop = '0';
        newForm.appendChild(BeginnerLevel);
        newForm.appendChild(WarmUpLevel);
        newForm.appendChild(MasterLevel);
        newForm.appendChild(ProLevel);
        newForm.appendChild(ExpertLevel);
