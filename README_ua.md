...
## Принцип роботи
1. Для того, щоб перевірити чи рівність правильна потрібно спочатку пропустити вхідні символи через лексичний аналізатор. 
2. Який створить токени потім на базі математичних операції побудувати дерево.
3. І рекурсивно його обходити з поступовим зменшенням пріорітету математичних операції. 
4. Дерево обходиться згідно правилами пріорітету операції ('()', '^', '*', '/', '+', '-'). 
5. Рекурсивна оцінка вузлів дерева дозволяє отримати значення виразу та перевірити, чи рівність є 
коректною (ліва частина == права частина).
